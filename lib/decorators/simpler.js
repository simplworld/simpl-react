...
function simpler(options) {
  return function (Component) {
        ...
        onReady: function onReady() {
          if (optionsWithDefaults.topics) {
            ...
            optionsWithDefaults.topics.forEach(function (topic) {
              ...
              dispatch((0, _simpl.getDataTree)(topic)).then(function (action) {
                var children = action.payload;
    ...
    var Simpler = function (_React$Component2) {
      _inherits(Simpler, _React$Component2);

      function Simpler() {
        _classCallCheck(this, Simpler);

        return _possibleConstructorReturn(this, (Simpler.__proto__ || Object.getPrototypeOf(Simpler)).apply(this, arguments));
      }

      _createClass(Simpler, [{
    ...
    var SimplerContainer = (0, _reactRedux.connect)(mapStateToProps, mapDispatchToProps)(Simpler);

    return SimplerContainer;
  };
}
