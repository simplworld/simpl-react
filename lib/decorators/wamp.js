      ...
      _createClass(WampContainer, [{
        ...
        value: function componentWillMount() {
          ...
          _autobahn2.default.Connection.onLost(function () {
            ...
            _this2.setState({ progress: 'offline' });
          });
          ...
          _autobahn2.default.Connection.onReady(function (_ref) {
            ...
            Object.keys(optionsWithDefaults.prefixes).forEach(function (key) {
              ...
              _this2.setState({ progress: 'connected' });
            });
          });
          _autobahn2.default.Connection.initialize(optionsWithDefaults.url, optionsWithDefaults.realm);
        ...
        value: function render() {
          if (this.state.progress === 'offline') {
            return _react2.default.createElement(
              'div',
              { className: 'wamp wamp-' + this.state.progress },
              _react2.default.createElement(optionsWithDefaults.progressComponent, _extends({}, this.props, this.state))
            );
          }
          return _react2.default.createElement(
            'div',
