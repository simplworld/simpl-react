...
function registers(Component, procedure) {
  ...
  var Listener = function (_React$Component) {
    ...
    _createClass(Listener, [{
      ...
      value: function componentDidMount() {
        ...
        this.props.Autobahn.Connection.onReady(function (_ref) {
        ...
        // eslint-disable-next-line no-unused-vars
        this.props.Autobahn.Connection.onLost(function (_ref3) {
          var _ref4 = _slicedToArray(_ref3, 2);

          var session = _ref4[0];
          var details = _ref4[1];

          _this2.register(_this2.props.Autobahn);
        });
      }
    }, {
      ...
      value: function unregister() {
        ...
        this.registrations.forEach(function (registration) {
          _this4.props.Autobahn.unregister(registration);
        });
      }
    }, {
      key: 'render',
  ...
  return (0, _reactRedux.connect)(mapStateToProps, mapDispatchToProps)(Listener);
}
