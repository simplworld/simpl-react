 ...
 */
function subscribes(Component, topics) {
    ...
    _createClass(SubscriptionContainer, [{
      ...
      value: function unsubscribe() {
        ...
        this.subscriptions.forEach(function (subscription) {
          ...
          _this5.props.Autobahn.unsubscribe(subscription);
        });
      }
    }, {
      key: 'appendMessage',
  ...
  return (0, _reactRedux.connect)(mapStateToProps, mapDispatchToProps)(SubscriptionContainer);
};
