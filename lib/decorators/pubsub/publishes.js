...
function publishes(Component, topic) {
  ...
  var Publisher = function (_React$Component) {
    ...
    _createClass(Publisher, [{
      ...
      value: function publish(payload) {
        ...
        return this.props.Autobahn.publish(resolvedTopic, args, kwargs, optionsWithDefaults).then(function (publication) {
  ...
  return (0, _reactRedux.connect)(mapStateToProps, mapDispatchToProps)(Publisher);
}
