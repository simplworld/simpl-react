      ...
      return {
        ...
        onReady: function onReady() {
          ...
          if (optionsWithDefaults.topics) {
            ...
            var topics = optionsWithDefaults.topics.slice(0);
            topics.forEach(function (topic) {
              ...
              dispatch((0, _simpl.getDataTree)(topic)).then(function (action) {
                ...
                for (var i = 0; i < children.length; i++) {
                  ...
                  var _topic = 'model:model.' + child.resource_name + '.' + child.pk;
                  console.log('add child topic: ' + _topic);
                  optionsWithDefaults.topics.push(_topic);
                }
              });
            });
          }
