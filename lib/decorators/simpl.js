    ...
    var mapDispatchToProps = function mapDispatchToProps(dispatch) {
      return {
        ...
        onReady: function onReady() {
              ...
              dispatch((0, _simpl.getRunUsers)(topic)).then(function (action) {
                ...
                for (var i = 0; i < runUsers.length; i++) {
                  ...
                  if (ru.data.user === authid) {
                    // only load current user's scenarios
          ...
          dispatch((0, _simpl.getPhases)('model:model.game')); // TODO still needed?
          console.log("getRoles('model:model.game')");
          dispatch((0, _simpl.getRoles)('model:model.game')); // TODO still needed?
