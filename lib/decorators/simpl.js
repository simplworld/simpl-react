        ...
        onReady: function onReady() {
          ...
          if (optionsWithDefaults.topics) {
            optionsWithDefaults.topics.forEach(function (topic) {
              ...
              dispatch((0, _simpl.getCurrentRunPhase)(topic)); // console.log(`dispatching getDataTree(${topic})`);

              dispatch((0, _simpl.getDataTree)(topic)); // console.log(`dispatching addTopic(${topic})`);
