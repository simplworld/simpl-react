 ...
 * @function
 * @memberof Simpl.actions.simpl
 * @param {Number} run_id - The run id on simpl-games-api.
 * @returns {NamedReduxAction}
 */

exports.showGenericError = showGenericError;
var setCurrentRun = (0, _reduxActions.createAction)('simpl/SET_CURRENT_RUN');
exports.setCurrentRun = setCurrentRun;
var getCurrentRun = (0, _reduxActions.createAction)('simpl/GET_CURRENT_RUN');
/**
 * @namespace simpl
