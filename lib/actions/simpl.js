...
var getDataTree = (0, _reduxActions.createAction)('simpl/DATATREE_GET', function (scope) {
  for (var _len = arguments.length, args = new Array(_len > 1 ? _len - 1 : 0), _key = 1; _key < _len; _key++) {
    args[_key - 1] = arguments[_key];
  }

  return _autobahn.default.call("".concat(scope, ".get_scope_tree"), args);
});
/**
...
var getRunUsers = (0, _reduxActions.createAction)('simpl/RUNUSERS_GET', function (scope) {
