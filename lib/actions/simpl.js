...
var getRunUserChatRooms = (0, _reduxActions.createAction)('simpl/GET_RUNUSER_CHATROOMS', function (topic) {
  for (var _len7 = arguments.length, args = new Array(_len7 > 1 ? _len7 - 1 : 0), _key7 = 1; _key7 < _len7; _key7++) {
    args[_key7 - 1] = arguments[_key7];
  }

  return _autobahn.default.call("".concat(topic, ".chat.rooms_for_user"), args);
});
/**
 * postChatMessage
 */

exports.getRunUserChatRooms = getRunUserChatRooms;
var postChatMessage = (0, _reduxActions.createAction)('simpl/POST_CHAT_MESSAGE', function (topic, roomSlug, authid, data) {
  return _autobahn.default.call("".concat(topic, ".chat.post_message"), [roomSlug, authid, data]);
});
/**
 * loadChatMessages
 */
...
var loadChatMessages = (0, _reduxActions.createAction)('simpl/LOAD_CHAT_MESSAGES', function (topic, roomSlug, authid) {
  return _autobahn.default.call("".concat(topic, ".chat.load_messages"), [roomSlug, authid]);
});
/**
 * receiveChatMessage
 */
...
var receiveChatMessage = (0, _reduxActions.createAction)('simpl/RECEIVE_CHAT_MESSAGE');
/**
 * @namespace simpl
...
var _default = {
  ...
  getRoles: getRoles,
  popError: popError,
  getRunUserChatRooms: getRunUserChatRooms,
