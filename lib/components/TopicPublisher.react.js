...
function (_React$Component) {
  ...
  function TopicPublisher() {
    ...
    return _possibleConstructorReturn(this, _getPrototypeOf(TopicPublisher).apply(this, arguments));
  }
  ...
  _createClass(TopicPublisher, [{
    ...
    value: function componentWillUpdate(nextProps) {
      var Child = _react.default.Children.only(nextProps.children).type;
    ...
    value: function render() {
      return _react.default.createElement("div", null, _react.default.createElement(this.Publisher, _extends({}, this.props, this.state)));
    }
  }]);
