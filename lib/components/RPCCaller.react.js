 ...
 */
var RPCCaller = function (_React$Component) {
  _inherits(RPCCaller, _React$Component);

  function RPCCaller() {
    _classCallCheck(this, RPCCaller);

    return _possibleConstructorReturn(this, (RPCCaller.__proto__ || Object.getPrototypeOf(RPCCaller)).apply(this, arguments));
  }
  ...
  _createClass(RPCCaller, [{
    ...
    value: function render() {
      return _react2.default.createElement(
        'div',
        null,
        _react2.default.createElement(this.RpcContainer, _extends({}, this.props, this.state))
      );
    }
  }]);
...
RPCCaller.propTypes = {
  callee: _react2.default.PropTypes.string.isRequired,
