...
var simpl = (0, _reduxRecycle2.default)((0, _reduxCreateReducer.createReducer)(initial, (_createReducer = {
...
}), _defineProperty(_createReducer, SimplActions.getRunUserInfo, function (state, action) {
  ...
  return _extends({}, state, { current_runuser: foundRunuser });
  ...
  action.payload.forEach(function (scenario) {
