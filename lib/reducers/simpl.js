...
var simpl = (0, _reduxRecycle2.default)((0, _reduxCreateReducer.createReducer)(initial, (_createReducer = {
  ...
  var index = newState[key].findIndex(function (scope) {
    return scope.pk === action.payload.pk;
  });
  if (index === -1) {
    return _extends({}, newState);
  }
  var updated = (0, _collections.popAtIndex)(newState[key], index);
  return _extends({}, newState, _defineProperty({}, key, updated));
