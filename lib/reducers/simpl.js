...
var simpl = (0, _reduxRecycle2.default)((0, _reduxCreateReducer.createReducer)(initial, (_createReducer = {
  ...
  return _extends({}, state, { user: foundRunuser });
}), _defineProperty(_createReducer, SimplActions.getScenarios, function (state, action) {
  var _this3 = this;
  ...
  return action.payload.reduce(function (memo, child) {
    return _this3.addChild(memo, { payload: child });
  }, _extends({}, state));
